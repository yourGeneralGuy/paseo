...
// WiFi Parameters
const char* network = "your-network-here";
...
// Project Notes
// Need to capture fingerprint buffer information and package it so it can be transmitted by Bluetooth
  // Use a function to package this... but how do I have this information presaved on the 